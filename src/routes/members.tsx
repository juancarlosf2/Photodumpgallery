          ...
          <div className="flex items-center justify-between">
            ...
            {!isLoading && data && (
              <p className="text-sm text-muted-foreground">
                {hasSearchQuery ? (
                  <>
                    Found <span className="font-medium text-foreground">{data.total}</span> member{data.total !== 1 ? "s" : ""}
                    {searchQuery && ` matching "${searchQuery}"`}
                  </>
                ) : (
                  <>
                    <span className="font-medium text-foreground">{data.total}</span> total member{data.total !== 1 ? "s" : ""}
                  </>
                )}
              </p>
            )}
